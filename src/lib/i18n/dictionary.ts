...
export const STRINGS = {
  en: {
    ...
    roomsMore: "More pictures",
    roomsEnd: "That's everything for this search.",
    roomsNext: "Next picture",
    roomsPrevious: "Previous picture",
  ...
  ar: {
    ...
    roomsMore: "المزيد من الصور",
    roomsEnd: "هذه كل نتائج هذا البحث.",
    roomsNext: "الصورة التالية",
    roomsPrevious: "الصورة السابقة",
    roomsAccount: "حسابك",
    roomsForYou: "لك",
    roomsAnime: "أنمي",
    roomsBusy: "نبحث…",
