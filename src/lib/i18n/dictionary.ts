...
export const STRINGS = {
  en: {
    ...
    roomsHeadline: "Find any picture.",
    roomsSearchPlaceholder: "Search photos, anime, places…",
    roomsTry: "Try a look",
    lookCarousel: "Carousel",
    lookGallery: "Gallery",
    lookFloating: "Floating",
    lookCarouselHint: "Scroll or drag to move · Tap the middle picture to open it",
    lookGalleryHint: "Scroll to glide through · Tap a picture to open it",
    lookFloatingHint: "Scroll to drift forward · Tap a picture to open it",
    roomsAccount: "Your account",
    roomsForYou: "For you",
    roomsAnime: "Anime",
    roomsBusy: "Searching…",
  ...
  ar: {
    ...
    roomsHeadline: "اعثر على أي صورة.",
    roomsSearchPlaceholder: "ابحث عن صور، أنمي، أماكن…",
    roomsTry: "جرّب شكلًا",
    lookCarousel: "عرض دوّار",
    lookGallery: "معرض",
    lookFloating: "صور سابحة",
    lookCarouselHint: "مرّر أو اسحب للتنقل · اضغط على الصورة الوسطى لفتحها",
    lookGalleryHint: "مرّر للتنقل بين الصور · اضغط على صورة لفتحها",
    lookFloatingHint: "مرّر لتتقدّم بين الصور · اضغط على صورة لفتحها",
    roomsAccount: "حسابك",
    roomsForYou: "لك",
    roomsAnime: "أنمي",
    roomsBusy: "نبحث…",
