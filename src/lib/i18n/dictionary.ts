...
export const STRINGS = {
  en: {
    ...
    roomsChoose: "Try a room",
    roomSpace: "Floating in space",
    roomSpaceTunnel: "Space tunnel",
    roomTunnel: "Tunnel",
    roomSpaceHint: "Scroll to fly forward · Tap a picture to open it",
    roomSpaceTunnelHint: "Scroll to fly through the tunnel · Tap a picture to open it",
    roomTunnelHint: "Scroll to move through the tunnel · Tap a picture to open it",
    roomsBusy: "Searching…",
  ...
  ar: {
    ...
    roomsChoose: "جرّب غرفة",
    roomSpace: "سابحة في الفضاء",
    roomSpaceTunnel: "نفق فضائي",
    roomTunnel: "نفق",
    roomSpaceHint: "مرّر للتقدّم إلى الأمام · اضغط على صورة لفتحها",
    roomSpaceTunnelHint: "مرّر لتطير عبر النفق · اضغط على صورة لفتحها",
    roomTunnelHint: "مرّر للتحرك داخل النفق · اضغط على صورة لفتحها",
    roomsBusy: "نبحث…",
